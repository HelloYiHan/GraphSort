...
class two_dim_data(InMemoryDataset):
    ...
    def __init__(self, zippath, root, name, transform=None, pre_transform=None,
                 pre_filter=None, use_node_attr=False, use_edge_attr=False):
        self.zippath = zippath
        self.name = name
        super(two_dim_data, self).__init__(root, transform, pre_transform, pre_filter)
    ...
    def download(self):
        ...
        extract_zip(self.zippath, self.root)
        #os.unlink(path)
